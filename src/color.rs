...
// +---------+----------------------------+----------------------------+
// | 6       | Rapid Blink                | MS-DOS ANSI.SYS; 150+ per  |
// |         |                            | minute; not widely         |
// |         |                            | supported                  |
// +---------+----------------------------+----------------------------+
// | 7       | [[reverse video]]          | swap foreground and        |
// |         |                            | background colors          |
// +---------+----------------------------+----------------------------+
// | 8       | Conceal                    | Not widely supported.      |
// +---------+----------------------------+----------------------------+
// | 9       | Crossed-out                | Characters legible, but    |
// |         |                            | marked for deletion. Not   |
// |         |                            | widely supported.          |
// +---------+----------------------------+----------------------------+
// | 10      | Primary(default) font      |                            |
// +---------+----------------------------+----------------------------+
// | 11–19   | Alternate font             | Select alternate font      |
// |         |                            | ``n-10``                   |
// +---------+----------------------------+----------------------------+
// | 20      | Fraktur                    | hardly ever supported      |
// +---------+----------------------------+----------------------------+
// | 21      | Bold off or Double         | Bold off not widely        |
// |         | Underline                  | supported; double          |
// |         |                            | underline hardly ever      |
// |         |                            | supported.                 |
// +---------+----------------------------+----------------------------+
...
// +---------+----------------------------+----------------------------+
// | 24      | Underline off              | Not singly or doubly       |
// |         |                            | underlined                 |
// +---------+----------------------------+----------------------------+
// | 25      | Blink off                  |                            |
// +---------+----------------------------+----------------------------+
...
// +---------+----------------------------+----------------------------+
// | 65      | ideogram attributes off    | reset the effects of all   |
// |         |                            | of 60-64                   |
// +---------+----------------------------+----------------------------+
// | 90–97   | Set bright foreground      | aixterm (not in standard)  |
// |         | color                      |                            |
// +---------+----------------------------+----------------------------+
// | 100–107 | Set bright background      | aixterm (not in standard)  |
// |         | color                      |                            |
// +---------+----------------------------+----------------------------+
